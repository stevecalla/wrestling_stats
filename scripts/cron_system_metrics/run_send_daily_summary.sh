...
if [ "$current_user" == "steve-calla" ]; then
    # mac
    JS_FILE="/home/steve-calla/development/wrestling/wrestling_stats/scripts/cron_system_metrics/send_daily_summary.js"
    ...
    JS_FILE="C:/Users/calla/development/ezhire/programs/scheduled_jobs/cron_system_metrics/send_daily_summary.js"
