...
# src\scheduled_jobs\scrape_girls_all_2024_25.js

if [ "$current_user" == "steve-calla" ]; then
    # mac
    JS_FILE="/home/steve-calla/development/wrestling/wrestling_stats/src/scheduled_jobs/scrape_girls_all_2024_25.js"
    ...
    # windows
    JS_FILE="C:/Users/calla/development/projects/wrestling_stats/src/scheduled_jobs/scrape_girls_all_2024_25.js"
