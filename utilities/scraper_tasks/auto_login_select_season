// if url contains seasons/index.jsp?
// click on scroll to right
    // <a href="javascript:defaultGrid.nextX()"><i aria-hidden="true" class="icon-arrow_r dgNext"></i></a>
// then click on href = 
    // <a href="javascript:seasonSelected(842514138)">2024-25 High School Boys</a>
    // don't scroll....
    // <a href="javascript:seasonSelected(1560212138)">2025-26 High School Boys</a>
// select Colorado
    // <select class="unchanged" id="gbId" name="gbId" title="* governing body" 
    // <option value="10">Colorado High School Activities Association</option>
// then clicks on the login button
    // <div> <input type="button" value="Login" onclick="publicLogin()" class="segment-track"> </div>
