  ...
  const alters = [
    `
      ALTER TABLE wrestler_match_history_metrics_data
        ADD COLUMN wrestler_team_division VARCHAR(255) NULL AFTER wrestler_team_id
    `,
    `
      ALTER TABLE wrestler_match_history_metrics_data
        ADD COLUMN wrestler_team_region VARCHAR(255) NULL AFTER wrestler_team_division
    `,
    `
      ALTER TABLE wrestler_match_history_metrics_data
        ADD COLUMN opponent_team_division VARCHAR(255) NULL AFTER opponent_team_id
    `,
    `
      ALTER TABLE wrestler_match_history_metrics_data
        ADD COLUMN opponent_team_region VARCHAR(255) NULL AFTER opponent_team_division
    `,
  ];
